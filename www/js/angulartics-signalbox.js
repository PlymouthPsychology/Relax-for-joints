...
(function(angular) {
    ...
    /**
     * @ngdoc overview
     * @name angulartics.signalbox
     * Enables analytics support for Signalbox 
     */
    angular.module('angulartics.signalbox', ['angulartics'])
        .config(['$analyticsProvider', '$windowProvider',
            function($analyticsProvider, $windowProvider) {
                ...
                // Add signalbox specific trackers to angulartics API
